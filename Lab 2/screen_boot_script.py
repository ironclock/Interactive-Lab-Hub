...
# Turn on the backlight (may not be needed for OLED displays).
# backlight = digitalio.DigitalInOut(board.D22)
# backlight.switch_to_output()
# backlight.value = True
...
while True:
    ...
    # If buttons or additional functionality is needed, you'll need to adapt the script to
    # manage the GPIO inputs for the buttons.
