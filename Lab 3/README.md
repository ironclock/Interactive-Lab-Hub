...
+ and the user was smooth and in line with what we imagined it to be. 
+ However, one thing we noticed from our interaction was that there 
+ may be a potential issue if the user gives more than one input to SpotiPi. 
